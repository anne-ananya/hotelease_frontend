    ...
    return (
        <div className="restaurant-container">
            ...
            <div className="options">
                <div>
                    <img src="/house-cleaning.png" alt="Hotel" className="icon" />
                    <button className="option-btn" onClick={handleScheduling}>Schedule Service</button>
                </div>
                <div>
